            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        {/* Appointment Button */}
                        <button className="border-2 border-primary text-primary hover:bg-primary hover:text-base-100 px-4 py-2 rounded-lg font-medium transition-colors duration-200">
                            Appointment
                        </button>
                    </div>
                    ...
                    <div className="md:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-100">
                            ...
                            <div className="flex items-center space-x-4 pt-4 border-t border-gray-100">
                                ...
                                <button className="border-2 border-primary text-primary hover:bg-primary hover:text-white px-4 py-2 rounded-lg font-medium transition-colors duration-200">
                                    Appointment
                                </button>
                            </div>
                        </div>
